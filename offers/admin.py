...
class OfferAdmin(admin.ModelAdmin):
    list_display = ['name', 'retailer', 'offer_type', 'value_type', 'value', 'is_active', 'start_date', 'end_date']
    list_filter = ['offer_type', 'value_type', 'is_active', 'start_date', 'end_date']
    search_fields = ['name', 'description', 'retailer__shop_name']
    ordering = ['-created_at']

@admin.register(OfferTarget)
class OfferTargetAdmin(admin.ModelAdmin):
    list_display = ['offer', 'target_type']
