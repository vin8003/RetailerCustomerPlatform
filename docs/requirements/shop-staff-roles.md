...
| `purchasing.terms` | Set or change `Supplier.payment_terms` (OE-100). Echoing the current value (or creating a supplier without terms) does not require the perm. Admin bootstrap includes it; cashier does not. |
