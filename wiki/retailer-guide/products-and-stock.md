...
3. Matching SKUs get the new photo as the default. If two files share the same name, the last one in the zip is used. Extra files that are not images (`readme.txt` and similar) are skipped.
